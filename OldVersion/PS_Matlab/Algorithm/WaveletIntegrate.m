function [Z,IterativeInfoOut] = WaveletIntegrate(P,Q,IterativeInfo,borderInfo,hFigure)
    tic;
    [Z,IterativeInfoOut0] = PQ2Z(P,Q,IterativeInfo,borderInfo,hFigure);
    timeVal=toc;
    IterativeInfoOut={'time','timelist','timeslist','errZList','errPQList';...
                      timeVal,IterativeInfoOut0{:}};
end
% function [P2,Q2] = PQ_Recurrence (P1,Q1)
% 
% end

function [A0,IterativeInfoOut] = PQ2Z(P1,Q1,IterativeInfo,borderInfo,hFigure)
%WaveletIntegrate: Optimize Z from P≈Zx Q≈Zy
...
%         timeThisScale=toc;
        ...
        if ~iscell(IterativeInfoOut1)
            ...
            timeslist=NaN;
            errZList=[errZ;IterativeInfoOut1{3}];
